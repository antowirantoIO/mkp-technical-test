...
func NewOperatorUseCase(db *gorm.DB, logger *logrus.Logger, validate *validator.Validate,
	operatorRepository *repository.OperatorRepository) *OperatorUseCase {
...
func (c *OperatorUseCase) Create(ctx context.Context, request *model.CreateOperatorRequest) (*model.OperatorResponse, error) {
...
func (c *OperatorUseCase) Update(ctx context.Context, request *model.UpdateOperatorRequest) (*model.OperatorResponse, error) {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
...
func (c *OperatorUseCase) Get(ctx context.Context, request *model.GetOperatorRequest) (*model.OperatorResponse, error) {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
...
func (c *OperatorUseCase) Delete(ctx context.Context, request *model.DeleteOperatorRequest) error {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
