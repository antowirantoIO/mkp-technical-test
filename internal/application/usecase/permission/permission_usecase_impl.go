...
func NewPermissionUseCase(db *gorm.DB, logger *logrus.Logger, validate *validator.Validate,
	permissionRepository repository.PermissionRepository) usecase.PermissionUseCase {
...
func (c *PermissionUseCaseImpl) Create(ctx context.Context, request *model.CreatePermissionRequest) (*model.PermissionResponse, error) {
...
func (c *PermissionUseCaseImpl) Update(ctx context.Context, request *model.UpdatePermissionRequest) (*model.PermissionResponse, error) {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
...
func (c *PermissionUseCaseImpl) Get(ctx context.Context, request *model.GetPermissionRequest) (*model.PermissionResponse, error) {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
...
func (c *PermissionUseCaseImpl) Delete(ctx context.Context, request *model.DeletePermissionRequest) error {
	tx := c.DB.WithContext(ctx).Begin()
	defer tx.Rollback()
	...
	// TODO: Check if permission is assigned to any roles when RolePermissionRepository is available
...
func (c *PermissionUseCaseImpl) List(ctx context.Context, request *model.ListPermissionRequest) (*model.WebResponse[[]model.PermissionResponse], error) {
